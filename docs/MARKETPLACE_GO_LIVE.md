...
```powershell
npx nandi-proxmox-mcp@0.3.0 --version
npx nandi-proxmox-mcp@0.3.0 setup
npx nandi-proxmox-mcp@0.3.0 doctor --check mcp-config,nodes,vms,cts,node-status,remote-op
```
